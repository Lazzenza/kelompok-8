            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="<?php echo e(asset('assets/img/user.jpg')); ?>" alt="" 
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo e(route('users')); ?>" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Users</a>
                    
                </div>
            </nav>
        </div>
        <!-- Sidebar End --><?php /**PATH C:\Users\ACER\ren_car\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>