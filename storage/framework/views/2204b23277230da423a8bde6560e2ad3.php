...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <!-- Spinner End -->
        <?php echo $__env->make('layout.sidebar-pelanggan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Content Start -->
        <div class="content">
            <?php echo $__env->make('layout.navbar-pelanggan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH E:\Joki\Jaki - Coding\resources\views/layout/template-pelanggan.blade.php ENDPATH**/ ?>