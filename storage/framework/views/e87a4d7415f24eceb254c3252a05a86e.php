...
<head>
    <meta charset="utf-8">
    <title>REGISTER - ARAP RENT</title>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>ARAP RENT</h3>
                            </a>
                            <h3>Sign Up</h3>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="text" name= "name" class="form-control" id="floatingText" placeholder="Name" value="<?php echo e(@old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name= "email" id="floatingInput" placeholder="name@example.com" value="<?php echo e(@old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" name="password" value="<?php echo e(@old('password')); ?>" id="floatingPassword" placeholder="Password">
...
</html><?php /**PATH C:\Users\ACER\ren_car\resources\views/register/index.blade.php ENDPATH**/ ?>